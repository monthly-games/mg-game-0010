...
### 핵심 기능
- [x] 아이템 제작 시스템 (재료 소비, 슬롯, 제작 시간)
- [x] 상점 진열/판매 (3개 슬롯, 골드 획득)
- [x] 던전 탐험 (탐험 타이머, 확률 드롭)
- [x] 레시피 시스템 (3개: WoodenSword/IronDagger/HealthPotion)
- [x] 방치 수익 (오프라인 보상, 최대 2시간)

### 콘텐츠
- [ ] 50+ 레시피 (현재 3개)
- [ ] 30+ 재료 (현재 3개: Wood/Iron/Herb)
- [ ] 5+ 던전 (현재 2개: Forest/Mine)
- [ ] NPC 모험가 다양화
- [x] 튜토리얼 (5단계)

### 메타 시스템
- [x] 프레스티지 시스템 (crafting_manager 리셋)
- [ ] 일일/주간 퀘스트
- [x] 도전과제 (master_crafter: 50개 제작)
- [ ] 설정 화면
- [ ] 친구 시스템
...
- [ ] 광고 SDK
- [ ] IAP 상품
- [x] 상점 UI (shop_screen, crafting_tab, dungeon_tab)
- [ ] 시즌 패스
