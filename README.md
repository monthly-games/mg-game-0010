...
이 프로젝트는 **던전 상점**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0010.json](docs/design/gdd_game_0010.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_idle_shop_hud.dart](game/lib/ui/hud/mg_idle_shop_hud.dart)
